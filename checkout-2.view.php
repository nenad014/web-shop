...
<div class="panel">
    <div class="panel-heading">
        ...
        <!-- Product Info -->
        <p><b>Item Name:</b> <?php echo $values["item_name"]; ?></p>
        <p><b>Price:</b> <?php echo $values["item_price"]; ?></p>
        
                <?php
                $total = $total + ($values['item_quantity'] * $values['item_price']);
                endforeach; ?>
                <h3 class="panel-title">Charge <?php echo number_format($total, 2); ?> RSD with Stripe</h3>
                <?php } ?>
